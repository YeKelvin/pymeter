...
class CoroutineGroup(LoopController):
    ...
    ON_SAMPLE_ERROR: Final = 'CoroutineGroup__on_sample_error'

    # 协程数
    NUMBER_COROUTINES: Final = 'CoroutineGroup__number_coroutines'

    # 每秒启动的协程数  todo 占坑，后面实现
    STARTUPS_PER_SECOND: Final = 'CoroutineGroup__startups_per_second'
