...
__MODULE_PATH__ = {
    # 测试集合
    'TaskCollection': 'taskmeter.elements.collection',

    # 协程组
    'TaskGroup': 'taskmeter.groups.group',

    # 断言器
    'JsonPathAssertion': 'taskmeter.assertions.json_path_assertion',
    'PythonAssertion': 'taskmeter.assertions.python_assertion',

    # 配置器
    'TestConfig': 'taskmeter.configs.test_config',
    'HttpHeader': 'taskmeter.configs.http_headers',
    'HttpHeaderManager': 'taskmeter.configs.http_headers',

    # 逻辑控制器
    'LoopController': 'taskmeter.controls.loop_controller',
    'IfController': 'taskmeter.controls.if_controller',

    # 前置处理器
    'PythonPreProcessor': 'taskmeter.processors.python_pre_processor',

    # 后置处理器
    'PythonPostProcessor': 'taskmeter.processors.python_post_processor',

    # 取样器
    'TestSampler': 'taskmeter.samplers.test_sampler',
    'HTTPSampler': 'taskmeter.samplers.http_sampler',
    'PythonSampler': 'taskmeter.samplers.python_sampler',
    'SQLSampler': 'taskmeter.samplers.sql_sampler',

    # 监听器
    'ResultCollector': 'taskmeter.listeners.result_collector',
    'SocketResultCollector': 'taskmeter.listeners.socket_result_collector',
    'FlaskSocketIOResultCollector': 'taskmeter.listeners.flask_socketio_result_collector'
}
